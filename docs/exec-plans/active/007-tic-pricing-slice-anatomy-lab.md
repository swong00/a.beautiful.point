...
| R1: reject exporter destinations that contain protected inputs or unrelated files; preserve previous output on replacement failure | Independent implementation review | blocks-current-plan | P1 | This plan's bounded pipeline exporter change | done — 2026-08-30 (destination safety + rename-swap preservation; 3 new tests, live refusal reproduced) |
...
| R3: anchor importer source/asset hashes to trusted release expectations | Independent implementation review | blocks-current-plan | P2 | Pinned importer and focused negative validation | done — 2026-08-30 (embedded trusted release descriptor; both reproduced attacks now refused) |
